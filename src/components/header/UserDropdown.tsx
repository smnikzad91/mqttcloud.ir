...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="relative overflow-hidden rounded-full h-9 w-9 shrink-0 border border-gray-200 dark:border-gray-700">
          <Image
            width={36}
            height={36}
            src={avatar}
        ...
        <span className="hidden sm:block font-medium text-theme-sm">{firstName}</span>
        <svg
          className={`stroke-gray-500 dark:stroke-gray-400 transition-transform duration-200 ${isOpen ? "rotate-180" : ""} ${lang === "fa" ? "scale-x-[-1]" : ""}`}
      ...
      >
        ...
        <div className="flex items-center gap-3 pb-3 border-b border-gray-200 dark:border-gray-800">
          <button
            ...
            disabled={uploading}
          >
            <span className="relative overflow-hidden rounded-full h-11 w-11 block border border-gray-200 dark:border-gray-700">
              <Image
                width={44}
                height={44}
                src={avatar}
          ...
          <div className="min-w-0">
            <span className="block font-medium text-gray-700 text-theme-sm dark:text-gray-200 truncate">
              {name}
            </span>
        ...
        <ul className="flex flex-col gap-1 pt-3 pb-3 border-b border-gray-200 dark:border-gray-800">
          <li>
            ...
            >
              <svg className={`fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300 ${lang === "fa" ? "scale-x-[-1]" : ""}`} width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        >
          <svg className={`fill-gray-500 group-hover:fill-gray-700 dark:group-hover:fill-gray-300 ${lang === "fa" ? "scale-x-[-1]" : ""}`} width="24" height="24" viewBox="0 0 24 24" fill="none">
